...
function main() {
  ...
  gui.addColor(controls, 'color').name('Lambert Color');
  gui.add(controls, 'amp', 0.0, 1.0).step(0.01).name('Deform Amp');
  gui.add(controls, 'freq', 0.0, 10.0).step(0.01).name('Deform Freq');
  gui.add(controls, 'noiseScale', 0.1, 5.0).step(0.01).name('Noise Scale');
  gui.add(controls, 'noiseAmp', 0.0, 2.0).step(0.01).name('Noise Amp');
